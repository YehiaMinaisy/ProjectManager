...
namespace ProjectManagerWebAPI.Migrations
{
    ...
    [Migration("20240709135819_UserUpdate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "261ac95e-0d0a-4600-ae49-25515ad535cf",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "79c50772-5a63-4a85-8e4e-0d520a111812",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("ProjectManagerWebAPI.Models.Task", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ProjectManagerWebAPI.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProjectManagerWebAPI.Models.Task", b =>
                {
                    b.HasOne("ProjectManagerWebAPI.Models.Task", "Parent")
                        .WithMany("subTasks")
            ...
            modelBuilder.Entity("TaskUser", b =>
                {
                    b.HasOne("ProjectManagerWebAPI.Models.Task", null)
                        .WithMany()
